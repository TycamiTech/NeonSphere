...
const graphData = {
    nodes: [
        ...
        { id: 'node14', label: 'Dynamic', size: 8, color: '#CCCCCC' },
        { id: 'node15', label: 'Static', size: 8, color: '#CCCCCC' },
        { id: 'node16', label: 'Communication', size: 8, color: '#CCCCCC' },
        { id: 'node17', label: 'Telecommunication', size: 8, color: '#CCCCCC' },
        { id: 'node18', label: 'Information', size: 8, color: '#CCCCCC' }
    ],
